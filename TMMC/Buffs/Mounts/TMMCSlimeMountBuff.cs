...
namespace TMMC.Buffs.Mounts
{
    public class TMMCSlimeMountBuff : ModBuff
    {
        public override void SetDefaults()
        {
            DisplayName.SetDefault("TMMC Mount");
            Description.SetDefault("Just a modded Slime Mount.");
            Main.buffNoTimeDisplay[Type] = true;
        }

        public override void Update(Player player, ref int buffIndex)
        {
            player.mount.SetMount(mod.MountType("TMMCMount"), player);
